...
partial class FrmCustomerHome
{
    ...
    private void InitializeComponent()
    {
        ...
        fieldsHeader.Dock=DockStyle.Fill;fieldsHeader.BackColor=Color.Transparent;lblFields.Text="★  Sân nổi bật";lblFields.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold);lblFields.ForeColor=Color.FromArgb(22,75,132);lblFields.AutoSize=true;lblFields.Location=new Point(8,9);fieldsHeader.Controls.Add(lblFields);
