...
partial class FrmEmployeeDashboard
{
    ...
    private void InitializeComponent()
    {
        ...
        pnlToday.Dock=DockStyle.Fill;pnlToday.Radius=14;pnlToday.BorderColor=Color.FromArgb(220,233,240);pnlToday.Padding=new Padding(12,8,12,10);pnlToday.Margin=new Padding(0,0,8,8);lblToday.Text="▣  Lịch đặt sân hôm nay";lblToday.Dock=DockStyle.Top;lblToday.Height=32;lblToday.Font=new Font("Segoe UI Semibold",10.5F,FontStyle.Bold);lblToday.ForeColor=Color.FromArgb(23,73,130);gridToday.Dock=DockStyle.Fill;pnlToday.Controls.Add(gridToday);pnlToday.Controls.Add(lblToday);
        pnlChart.Dock=DockStyle.Fill;pnlChart.Radius=14;pnlChart.BorderColor=Color.FromArgb(220,233,240);pnlChart.Padding=new Padding(10,8,10,8);pnlChart.Margin=new Padding(0,0,0,8);lblChart.Text="▣  Doanh thu 7 ngày gần đây";lblChart.Dock=DockStyle.Top;lblChart.Height=32;lblChart.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold);lblChart.ForeColor=Color.FromArgb(23,73,130);chart.Dock=DockStyle.Fill;pnlChart.Controls.Add(chart);pnlChart.Controls.Add(lblChart);
        pnlQuick.Dock=DockStyle.Fill;pnlQuick.Radius=14;pnlQuick.BorderColor=Color.FromArgb(220,233,240);pnlQuick.Padding=new Padding(10,8,10,10);pnlQuick.Margin=new Padding(0,0,0,0);lblQuick.Text="⌁  Thao tác nhanh";lblQuick.Dock=DockStyle.Top;lblQuick.Height=32;lblQuick.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold);lblQuick.ForeColor=Color.FromArgb(23,73,130);quickGrid.Dock=DockStyle.Fill;quickGrid.ColumnCount=2;quickGrid.RowCount=2;quickGrid.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,50));quickGrid.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,50));quickGrid.RowStyles.Add(new RowStyle(SizeType.Percent,50));quickGrid.RowStyles.Add(new RowStyle(SizeType.Percent,50));pnlQuick.Controls.Add(quickGrid);pnlQuick.Controls.Add(lblQuick);
