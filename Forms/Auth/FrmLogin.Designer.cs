...
partial class FrmLogin
{
    ...
    private void InitializeComponent()
    {
        ...
        pnlUsername.BackColor=Color.FromArgb(8,50,59);pnlUsername.Location=new Point(30,182);pnlUsername.Size=new Size(398,48);pnlUsername.Padding=new Padding(12,8,12,8);pnlUsername.Paint+=(_,e)=>{using var p=new Pen(Color.FromArgb(57,100,110));e.Graphics.DrawRectangle(p,0,0,pnlUsername.Width-1,pnlUsername.Height-1);};
        ...
        pnlPassword.BackColor=Color.FromArgb(8,50,59);pnlPassword.Location=new Point(30,272);pnlPassword.Size=new Size(398,48);pnlPassword.Padding=new Padding(12,8,12,8);pnlPassword.Paint+=(_,e)=>{using var p=new Pen(Color.FromArgb(57,100,110));e.Graphics.DrawRectangle(p,0,0,pnlPassword.Width-1,pnlPassword.Height-1);};
