...
partial class FrmAdminDashboard
{
    ...
    private void InitializeComponent()
    {
        ...
        lblGreeting.Text="☀  Xin chào!"; lblGreeting.AutoSize=true; lblGreeting.Font=new Font("Segoe UI Semibold",15F,FontStyle.Bold); lblGreeting.ForeColor=Color.FromArgb(22,75,132); lblGreeting.Location=new Point(4,4);
        ...
        btnNewBooking.Text="＋  Đặt sân"; btnNewBooking.Size=new Size(112,38); btnNewBooking.Anchor=AnchorStyles.Top|AnchorStyles.Right; btnNewBooking.BackColor=Color.FromArgb(14,170,159); btnNewBooking.ForeColor=Color.White; btnNewBooking.Font=new Font("Segoe UI Semibold",9F,FontStyle.Bold); btnNewBooking.HoverColor=Color.FromArgb(8,145,137); btnNewBooking.Radius=9; btnNewBooking.Location=new Point(1080,7);
        ...
        lblSchedule.Text="▣  Lịch sân hôm nay"; lblSchedule.Dock=DockStyle.Top; lblSchedule.Height=32; lblSchedule.Font=new Font("Segoe UI Semibold",10.5F,FontStyle.Bold); lblSchedule.ForeColor=Color.FromArgb(23,73,130); lblSchedule.TextAlign=ContentAlignment.MiddleLeft;
        ...
        lblRecent.Text="◷  Đặt sân gần đây"; lblRecent.Dock=DockStyle.Top; lblRecent.Height=32; lblRecent.Font=new Font("Segoe UI Semibold",10.5F,FontStyle.Bold); lblRecent.ForeColor=Color.FromArgb(23,73,130); lblRecent.TextAlign=ContentAlignment.MiddleLeft;
        ...
        lblStatus.Text="▣  Trạng thái sân"; lblStatus.Dock=DockStyle.Top; lblStatus.Height=30; lblStatus.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold); lblStatus.ForeColor=Color.FromArgb(23,73,130);
        ...
        lblRevenue.Text="▣  Doanh thu 7 ngày gần đây"; lblRevenue.Dock=DockStyle.Top; lblRevenue.Height=30; lblRevenue.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold); lblRevenue.ForeColor=Color.FromArgb(23,73,130);
        ...
        lblQuick.Text="⌁  Thao tác nhanh"; lblQuick.Dock=DockStyle.Top; lblQuick.Height=30; lblQuick.Font=new Font("Segoe UI Semibold",10F,FontStyle.Bold); lblQuick.ForeColor=Color.FromArgb(23,73,130);
